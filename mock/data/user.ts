...
export const route: Array<IMenubarList> = [
  ...
  },
  {
    ...
    path: '/Bud',
    component: 'Layout',
    redirect: '/Bud/BudApply',
    meta: { title: '权限测试', icon: 'el-icon-phone' }
  },
  {
    id: 60,
    parentId: 6,
    ...
    path: '/Bud/BudApply',
    component: 'BudApply',
    meta: { title: '权限Test1', icon: 'el-icon-goods' }
  },
  {
    id: 61,
    parentId: 6,
    ...
    path: '/Bud/BudList',
    component: 'BudList',
    meta: { title: '权限Test2', icon: 'el-icon-goods' }
  }
]
